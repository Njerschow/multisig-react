...
} from 'src/routes/safe/components/Swap/Tokens/screens/AddCustomAsset/validators'
import TokenPlaceholder from 'src/routes/safe/components/Swap/assets/token_placeholder.svg'
